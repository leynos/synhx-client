...
extern void haval_buffer(unsigned char *buf, size_t len, unsigned char *fpt,
                         int fptlen, int passes); /* hash a buffer */
extern int haval_fd(int fd, size_t maxlen, unsigned char *fpt, int fptlen,
                    int passes); /* hash a file */
extern void haval_start(haval_state *, int fptlen,
                        int passes); /* initialization */
extern void haval_hash(haval_state *, unsigned char *,
