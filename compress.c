...
u_int32_t compress_decode(struct htlc_conn *htlc, struct qbuf *out,
...
static u_int32_t do_encode(struct htlc_conn *htlc, u_int32_t pos,
                           u_int32_t len) {
...
u_int32_t compress_encode(struct htlc_conn *htlc, u_int32_t pos,
                          u_int32_t len) {
...
void compress_encode_init(struct htlc_conn *htlc) {
  z_stream *stream = &htlc->compress_encode_state.stream;
  int err;
...
void compress_decode_init(struct htlc_conn *htlc) {
  z_stream *stream = &htlc->compress_decode_state.stream;
  int err;
...
void compress_encode_end(struct htlc_conn *htlc) {
  z_stream *stream = &htlc->compress_encode_state.stream;
...
void compress_decode_end(struct htlc_conn *htlc) {
  z_stream *stream = &htlc->compress_decode_state.stream;
