...
struct htxf_hdr {
  u_int32_t magic, ref, len, unknown;
};

struct hl_filelist_hdr {
  u_int16_t type, len;
  u_int32_t ftype, fcreator;
  u_int32_t fsize, unknown, fnlen;
  u_int8_t fname[ZERO_SIZE_ARRAY_SIZE];
};

struct hl_userlist_hdr {
  u_int16_t type, len;
  u_int16_t uid, icon, color, nlen;
...
#if WORDS_BIGENDIAN
  u_int32_t delete_files : 1, upload_files : 1, download_files : 1,
      rename_files : 1, move_files : 1, create_folders : 1, delete_folders : 1,
      rename_folders : 1, move_folders : 1, read_chat : 1, send_chat : 1,
      __reserved0 : 3, create_users : 1, delete_users : 1, read_users : 1,
      modify_users : 1, __reserved1 : 2, read_news : 1, post_news : 1,
      disconnect_users : 1, cant_be_disconnected : 1, get_user_info : 1,
      upload_anywhere : 1, use_any_name : 1, dont_show_agreement : 1,
      comment_files : 1, comment_folders : 1, view_drop_boxes : 1,
      make_aliases : 1, can_broadcast : 1, __reserved2 : 7, __reserved3 : 24;
#else /* assumes little endian */
  u_int32_t rename_folders : 1, delete_folders : 1, create_folders : 1,
      move_files : 1, rename_files : 1, download_files : 1, upload_files : 1,
      delete_files : 1, delete_users : 1, create_users : 1, __reserved0 : 3,
      send_chat : 1, read_chat : 1, move_folders : 1, cant_be_disconnected : 1,
      disconnect_users : 1, post_news : 1, read_news : 1, __reserved1 : 2,
      modify_users : 1, read_users : 1, make_aliases : 1, view_drop_boxes : 1,
      comment_folders : 1, comment_files : 1, dont_show_agreement : 1,
      use_any_name : 1, upload_anywhere : 1, get_user_info : 1, __reserved2 : 7,
      can_broadcast : 1, __reserved3 : 24;
#endif
};
